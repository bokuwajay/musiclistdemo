...
import 'package:keysoctest/core/cache/local_storage.dart';
...
class SecureLocalStorage implements LocalStorage {
  ...
  Future<dynamic> load({required String key, String? boxName}) async {
    try {
      ...
      logger.e(
          'Logger in load of Secure Local Storage:\nException: $exception\nBox Name: $boxName\nKey: $key');
  ...
  Future<void> save({
    ...
    try {
      ...
      logger.e(
          'Logger in save of Secure Local Storage:\nException: $exception\nBox Name: $boxName\nKey: $key\nValue: $value');
      throw CacheException;
    }
  }
  ...
  Future<void> delete({required String key, String? boxName}) async {
    try {
      ...
      logger.e(
          'Logger in delete of Secure Local Storage:\nException: $exception\nBox Name: $boxName\nKey: $key');
      throw CacheException;
    }
  }
}
